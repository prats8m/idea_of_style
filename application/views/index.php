...
<head>
	...
	<link rel="stylesheet" type="text/css" href="http://ideaofstyle.tk/idea_of_style/assets/font-awesome/css/font-awesome.min.css">
	<link rel="stylesheet" href="http://ideaofstyle.tk/idea_of_style/assets/css/owl.carousel.css">
	<link rel="stylesheet" href="http://ideaofstyle.tk/idea_of_style/assets/css/owl.carousel.min.css">
	<link rel="stylesheet" href="http://ideaofstyle.tk/idea_of_style/assets/css/owl.theme.default.min.css">
	<link rel="stylesheet" href="http://ideaofstyle.tk/idea_of_style/assets/ionicons-2.0.1/css/ionicons.min.css">
	<link rel="stylesheet" href="http://ideaofstyle.tk/idea_of_style/assets/css/magnific-popup.css">
							...
							<div class="row p0">
								<div class="img-box grid-item">
									...
									<a href="#1" class="inline-popup">
										<img src="http://ideaofstyle.tk/idea_of_style/assets/images/Home_1.jpg" class="img-responsive" alt="Responsive image">
									</a>
								</div>
							</div>
						</div>
								...
								<div class="row">
									<div class="pop-up-color">
										<div class="col-md-7 p-l-0 p-r-0">
											<img src="http://ideaofstyle.tk/idea_of_style/assets/images/1.jpg" class="img-responsive" alt="Responsive image">
										</div>
										<div class="col-md-5">
											<div>
							...
							<div class="row p0">
								<div class="img-box grid-item">
									...
									<a href="#2" class="inline-popup">
										<img src="http://ideaofstyle.tk/idea_of_style/assets/images/2.jpg" class="img-responsive" alt="Responsive image">
									</a>
								</div>
							</div>
						</div>
							...
							<div class="row p0">
								<div class="img-box grid-item grid-item--width2">
									...
									<a href="#3" class="inline-popup">
										<img src="http://ideaofstyle.tk/idea_of_style/assets/images/Home_3.jpg" class="img-responsive" alt="Responsive image">
									</a>
								</div>
							</div>
						</div>
						...
						<div id="3" class="white-popup mfp-hide">
						  	<div class="container-fluid">
								<div class="row">
									<div class="pop-up-color">
										<div class="col-md-7 p-l-0 p-r-0">
											<img src="http://ideaofstyle.tk/idea_of_style/assets/images/3.jpg" class="img-responsive" alt="Responsive image">
										</div>
										<div class="col-md-5">
											<div>
							...
							<div class="row p0">
								<div class="img-box grid-item">
									...
									<a href="#4" class="inline-popup">
										<img src="http://ideaofstyle.tk/idea_of_style/assets/images/Home_4.jpg" class="img-responsive" alt="Responsive image">
									</a>
								</div>
							</div>
						</div>
						...
						<div id="4" class="white-popup mfp-hide">
						  	<div class="container-fluid">
								<div class="row">
									<div class="pop-up-color">
										<div class="col-md-7 p-l-0 p-r-0">
											<img src="http://ideaofstyle.tk/idea_of_style/assets/images/4.jpg" class="img-responsive" alt="Responsive image">
										</div>
										<div class="col-md-5">
											<div>
							...
							<div class="row p0">
								<div class="img-box grid-item">
									...
									<a href="#5" class="inline-popup">
										<img src="http://ideaofstyle.tk/idea_of_style/assets/images/Home_5.jpg" class="img-responsive" alt="Responsive image">
									</a>
								</div>
							</div>
						</div>
						...
						<div id="5" class="white-popup mfp-hide">
						  	<div class="container-fluid">
								<div class="row">
									<div class="pop-up-color">
										<div class="col-md-7 p-l-0 p-r-0">
											<img src="http://ideaofstyle.tk/idea_of_style/assets/images/5.jpg" class="img-responsive" alt="Responsive image">
										</div>
										<div class="col-md-5">
											<div>
							...
							<div class="row p0">
								<div class="img-box grid-item grid-item--width2">
									...
									<a href="#6" class="inline-popup">
										<img src="http://ideaofstyle.tk/idea_of_style/assets/images/Home_6.jpg" class="img-responsive" alt="Responsive image">
									</a>
								</div>
							</div>
						</div>
						...
						<div id="6" class="white-popup mfp-hide">
						  	<div class="container-fluid">
								<div class="row">
									<div class="pop-up-color">
										<div class="col-md-7 p-l-0 p-r-0">
											<img src="http://ideaofstyle.tk/idea_of_style/assets/images/6.jpg" class="img-responsive" alt="Responsive image">
										</div>
										<div class="col-md-5">
											<div>
					...
					<div class="contact-info">
						<div class="contact-info-content">
							...
							<div class="img-wrapper">
								<img class="img-responsive" src="http://ideaofstyle.tk/idea_of_style/assets/images/icons/address.png" alt="" />
							</div>
						...
						<div class="contact-info-content">
							<h4 class="">PHONE</h4>
							<div class="img-wrapper">
								<img class="img-responsive" src="http://ideaofstyle.tk/idea_of_style/assets/images/icons/call.png" alt="" />
							</div>
						...
						<div class="contact-info-content">
							<h4 class="">EMAIL</h4>
							<div class="img-wrapper">
								<img class="img-responsive" src="http://ideaofstyle.tk/idea_of_style/assets/images/icons/email.png" alt="" />
							</div>
							<p>Idea Of Style@mail.com <br>invationofficial@mail.com</p>
						</div>
					</div> <!-- /.contact-info -->
				</div>
			</div>			
			...
			<div class="row">
				<div class="social-contact">
					<div class="col-md-6">
						<div class="row">
							<div class="col-md-4">
								<p class="logo">INVENTI<span><img src="http://ideaofstyle.tk/idea_of_style/assets/images/logo.png"></span>N</p>
							</div>
							<div class="col-md-8">
								<div class="row">
									<div class="col-md-4">
